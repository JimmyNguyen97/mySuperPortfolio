    ...
    <div className="about__container" id="about">
      <div className="about__text">
        ...
        <p>
          ...
          crafts. Whether it be hobbies or my career, I like to perform my best and compete with myself. I am very familiar with losses and failure because those are situations where I believe people learn the most. If you're not pushing yourself, you're limiting your own growth.
        </p>
        <p>
